...
public class WebGlobals implements java.io.Serializable {
    ...
    public WebGlobals(WebConfig webConfig) {
        ...
        try {
            ...
            this.mailContactTo = properties.getProperty("mail.contact.to");
            this.mailDeveloperTo = properties.getProperty("mail.developer.to");
            this.mailHost = properties.getProperty("mail.server.host");
